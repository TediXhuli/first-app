...
<form class="form bg-white p-6 border-1" method="POST" action="{{route('guitars.update',['guitar'=>$guitar->id])}}">
    ...
    <div>
        ...
        <input class="text-lg border-1" type="text" id="brand" value='{{old('guitar->brand')}}' name="brand">
        @error('brand')
        <div class="form-error">
            {{$message}}
        </div>
    ...
    <div>
        ...
        <input class="text-lg border-1" type="text" id="year" value='{{old('guitar->year_made')}}'  name="year">
        @error('year')
        <div class="form-error">
            {{$message}}
        </div>
